...
<div class="hidden md:flex justify-center w-full">
    <ul class="font-medium flex flex-col md:flex-row md:space-x-8 bg-red-600 md:bg-transparent md:border-0 p-4 md:p-0 mt-4 md:mt-0 rounded-lg md:rounded-none border border-white md:border-none">
        <li>
            <x-nav-link :href="route('home.index')" :active="request()->routeIs('home.index')" class="block py-2 px-3 text-white hover:text-red-300">Home</x-nav-link>
        </li>
        <li>
            <x-nav-link :href="route('noticias.index')" :active="request()->routeIs('noticias.index')" class="block py-2 px-3 text-white hover:text-red-300">Noticias</x-nav-link>
        </li>
    </ul>
</div>
        ...
        <div class="hidden md:flex md:items-center space-x-4">
            @if (Route::has('login'))
                @auth
                    <a href="{{ url('/dashboard') }}" class="rounded-full px-4 py-2 bg-white text-red-700 border border-white transition hover:bg-red-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-red-300">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="rounded-full px-4 py-2 bg-white text-red-700 border border-white transition hover:bg-red-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-red-300">Inicio</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="rounded-full px-4 py-2 bg-white text-red-700 border border-white transition hover:bg-red-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-red-300">Registrar</a>
                    @endif
                @endauth
            @endif
        </div>
