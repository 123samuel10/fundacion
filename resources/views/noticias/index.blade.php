<x-layout>
    <h1 class="text-4xl font-bold mb-8 text-center" style="font-family: 'Fredericka the Great', cursive;">Noticiassss</h1>
 ...
 {{-- Muestra la primera imagen del post --}}
                    ...
                    <img class="w-full h-48 object-cover" src="{{ asset('storage/posts' . $post->image_url) }}" alt="{{ $post->title }}" />
                </a>
                <div class="p-5">
                    <a href="{{ route('posts.show', $post->id) }}">
